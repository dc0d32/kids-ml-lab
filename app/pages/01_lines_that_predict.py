...
You already know how to answer. You would draw a line through the dots and read the
height at week 20.

Congratulations. That line is a model. It is a tiny machine that turns a week number
into a dollar guess.
"""
)
...
st.markdown(
    "Try the line **dollars = 3 × weeks + 5** on four rounded rows. "
    "The plot below uses all eight real points."
)
...
st.markdown(
    "A mistake of +2 and a mistake of -2 both hurt. Squaring makes both become 4. "
    "A mistake of 8 becomes 64, so big misses get loud."
)
...
ui.show(fig)
st.markdown("Those red boxes are not decoration. Their areas are the squared mistakes.")
...
st.markdown("The gradient says: which way is downhill, and how steep is it?")
...
ui.aha("The model **is two numbers**: w and b. That is the whole machine.")
...
ui.show(fig)
ui.careful("A straight line is a rough tool here. Rain, holidays, seasons, and luck also matter.")
...
2. **Break it on purpose.** Move w and b until the error becomes huge.
3. **Outlier test.** Imagine dragging one dot far upward. Which way would the best line tilt?
