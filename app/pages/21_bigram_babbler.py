...
""",
    ...
    lesson.careful("The babbler sounds almost name-like, but it only looks one letter back. It has no idea what happened three letters ago. That wall is Chapter 22.")
