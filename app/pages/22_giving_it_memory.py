...
def _():
    guess = lesson.predict(
        ...
        ["Random guessing", "The Chapter 21 bigram", "The three-letter MLP"],
        correct=2,
...
""",
    ...
    lesson.careful("A block size of 3 is a hard wall. The fourth-back letter is invisible. Chapter 23 fixes that in a different way.")
