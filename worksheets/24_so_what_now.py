"""Chapter 24 workbook · So What Now?"""
...
WORKBOOK = Workbook(
    ...
    questions=[
        Question(
            ...
            kind="choice",
            choices=["Chapter 19 k-means", "Chapter 04 probabilities", "Chapter 21 bigrams"],
            answer="Chapter 19 k-means",
        ...
        Question(
            ...
            why="Chapter 23 trained a model to produce likely-looking text, not guaranteed-true text. Looking right and being right are different targets.",
        ),
        Question(
