"""Chapter 18 workbook · Pictures Are Numbers."""
    ...
    questions=[
        ...
        Question(
            ...
            why=(
                ...
                "Chapter 19 puts that neighbour idea back."
            ),
        ),
        Question(
            ...
            why=(
                "Rows are true answers and columns are guesses, like in Chapter 10. Off-diagonal cells are the model's mix-up spots."
            ),
        ),
    ],
    kid_corner=(
