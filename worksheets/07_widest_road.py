...
WORKBOOK = Workbook(
    ...
    questions=[
        Question(
            ...
            why="The closest blue point has x = 2, so the gap is `2.5 - 2 = **0.5**`. The road hugs the blue side, so a small wiggle could cross it.",
        ),
        Question(
            ...
            why="The closest red point has x = 4, so the gap is `4 - 2.5 = **1.5**`. The smallest safety gap for this road is still only 0.5, because the tight side decides safety.",
        ),
        Question(
            ...
            why="Both nearest gaps are **1.0**, so the smallest safety gap is 1.0. This road is more centered, which gives new points more room to wiggle before crossing sides.",
        ),
        Question(
            ...
            answer="x = 3.0",
            table=ROADS,
            why="**x = 3.0** has the bigger smallest gap. The widest-road choice is safer for new points because measurement wiggles or slightly unusual examples are less likely to cross the boundary.",
        ),
        Question(
            ...
            table=POINTS,
            why="The closest points are (2, 2) and (4, 2). These are the support-vector idea: points touching the margin determine the road because they are the first obstacles the road hits.",
        ),
        Question(
            ...
            answer="no, not much",
            why="Far-away points often do not matter because they are not touching the safety road. You could wiggle them a bit and the widest gap would stay the same.",
        ),
        Question(
            ...
            why="A closest point can be a support vector. Remove it, and the old obstacle is gone, so the widest safe road may jump to a new position.",
        ),
        Question(
            ...
            why="**C** controls strictness. Low C allows a wider road with a few mistakes; high C treats training mistakes as expensive, so the boundary may narrow or bend to chase every dot.",
        ),
        Question(
            ...
            why="**gamma** controls reach for the RBF road. Low gamma gives broad smooth influence; huge gamma gives short reach and can make tiny islands around points.",
        ),
    ],
    kid_corner=(
