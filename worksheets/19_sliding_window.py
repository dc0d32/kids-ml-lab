"""Chapter 19 workbook · The Sliding Window."""
...
WORKBOOK = Workbook(
    ...
    questions=[
        ...
        Question(
            ...
            kind="open",
            why=(
                "It may fail confidently. That is the Chapter 11 problem again: models are strongest inside the world their training data showed them."
            ),
        ),
    ],
    kid_corner=(
