"""Chapter 10 workbook · Real Data, Real Mess."""
...
WORKBOOK = Workbook(
    ...
    questions=[
        ...
        Question(
            ...
            why=(
                ...
                "or it can be a leaked answer in disguise."
            ),
        ),
        Question(
    ...
    closing="Chapter 11 starts from that 80% always-no trick and shows why a shiny score can be useless.",
)
