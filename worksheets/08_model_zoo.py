...
WORKBOOK = Workbook(
    ...
    questions=[
        Question(
            ...
            table=MODEL_NAMES,
            why="Logistic regression uses a straight-line boundary, then adds probabilities around it.",
        ),
        Question(
            ...
            why="A tree asks yes/no questions. On a picture, those questions make blocky boxes and stair steps.",
        ),
        Question(
            ...
            why="A forest is many trees voting, so it keeps the tree's boxy style but steadies it with a crowd.",
        ),
        Question(
            ...
            why="An RBF SVM can make smooth islands around groups of points. The gamma knob controls how far each point reaches.",
        ),
        Question(
            ...
            why="kNN asks the nearby training points to vote. Its personality is local: neighbours matter most.",
        ),
        Question(
            ...
            why="(0.80 + 0.70 + 0.90 + 0.80 + 0.60) / 5 = **0.76**. Cross-validation reports a fairer average over several hidden chunks.",
        ),
        Question(
            ...
            why="Highest is 0.90 and lowest is 0.60, so the range is **0.30**. A score without a spread hides how jumpy the result was.",
        ),
        Question(
            ...
            answer="test score",
            why=(
                "The test score is the honest one for new rows. The training score mostly asks whether the model learned or memorised the rows it already saw."
            ),
        ),
        Question(
            ...
            why="The lazy model scores **90%**. That sounds strong, but it completely fails at finding dogs.",
        ),
        Question(
            ...
            choices=["yes", "no"],
            answer="no",
            why="No. High accuracy can mislead on lopsided data. A model can score well by copying the most common answer and still miss the important cases.",
        ),
    ],
    kid_corner=(
