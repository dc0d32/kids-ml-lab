...
# ---
#
# Chapter 21 counted one letter back. This chapter gives the guesser three letters of memory.
...
# ## 💻 For Real
#
# Does the neural net beat the Chapter 21 bigram on the same held-out words?
...
# > Chapter 23 fixes that in a different way.
...
# %% [markdown]
# ---
# **Next up:** Chapter 23 · *Paying Attention* — the T in GPT, built tiny.
