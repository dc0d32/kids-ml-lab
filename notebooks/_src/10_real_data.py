...
# `is_boss`: yes or no.
#
# You choose a team of clues, train, then see which clues the model leaned on. If one
# column towers over the bar chart, ask whether it is a real clue or a sneaky shortcut.
...
# %% [markdown]
# Look for points far from the dashed perfect line. Those are the days the model got most
# wrong, and they are the ones worth explaining.
...
# %% [markdown]
# ---
# **Next up:** Chapter 11 · *Where Models Go Wrong* — when a shiny score is not an honest score.
