...
#
# The model has no alarm for "this point is nothing like what I trained on." Chapter 00 warned you: a model answers anyway.
...
# %% [markdown]
# ---
# **Next up:** Chapter 12 · *Arrows and Grids* — matrices become space movers before neurons use them.
