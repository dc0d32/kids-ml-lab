...
# then shows the weakness that Chapter 19 will fix.
...
# > corners, holes, and edges. Chapter 19 bolts that neighbour map back on.
...
# %% [markdown]
# A model keeps one separate weight — a number it can turn up or down — for every input
# pixel, and has to learn all of them:
#
...
# %% [markdown]
# In Chapter 10 you met this picture: rows are true answers, columns are guesses. Look
...
# %% [markdown]
# ---
# **Next up:** Chapter 19 · *The Sliding Window* — where the model learns that neighbours matter.
